...
// crc modbus - use this to tran & recv sensor value
...
unsigned short int CRC16 (unsigned char* puchMsg,unsigned short usDataLen ){ /* The function returns the CRC as a unsigned short type */
